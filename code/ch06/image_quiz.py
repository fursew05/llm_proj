...
def image_quiz(image_path,n_trial=0,max_trial=3):
    ...
    Listening : Which of the following descriptions of the image is corrected?
    (1) : It shows people buying breat at a bakery.
    ...
    정답 : (4) 점원은 노란색 티셔츠가 아니라 파란색 티셔츠를 입었습니다.
    ...
    try : 
       ...
       messages = messages 
        ...
        print("failed\n" + e)
        return image_quiz(image_path=image_path, n_trial = n_trial+1)
